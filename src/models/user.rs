...
//     }
//
//     pub fn login(login: LoginDTO, conn: &mut Connection) -> Result<LoginInfoDTO, APIError> {
...
//     }
//
//     pub fn find_user_by_id(user_id: &Uuid, conn: &mut Connection) -> Result<Self, APIError> {
//         match users::table
...
//     }
//
//     pub fn update_user(user_id: Uuid, user_update: UpdateUserDTO, conn: &mut Connection) -> Result<Self, APIError> {
//         if let Ok(user) = User::find_user_by_id(&user_id, conn) {
...
//     }
//
//     pub fn delete_user(user_id: Uuid, conn: &mut Connection) -> Result<String, APIError> {
